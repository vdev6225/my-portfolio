    ...
    <nav className="bg-primary border-border h-16 overflow-hidden border-b">
      <div className="mx-auto flex h-full w-dvw max-w-[1200px] items-center justify-between px-4 py-1">
        {isVisible ? (
          ...
          <Link href="/">
            <div className="animate-fade-up text-primary-content relative flex items-center gap-1  transition-all duration-300 md:static">
              {/* <Logo /> */}
              <Image src={Logo} alt="Logo" width="50" />
              <span className="text-primary-content">vishnu</span>
            </div>
          </Link>
        )}
