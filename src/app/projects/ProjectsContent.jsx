...
export default function ProjectsPage() {
  return (
    <main className="min-h-screen pt-10 pb-20 md:pt-20">
      {/* PAGE HEADER */}
          ...
          <section key={category}>
            ...
            <div className="mt-10 grid grid-cols-1 gap-5 md:grid-cols-2 lg:grid-cols-3">
              {projects.map((project, index) => (
                <div
                  key={index}
                  className="group bg-secondary relative flex flex-col justify-between overflow-hidden rounded-xl border border-slate-800 p-5 transition-all duration-300 hover:-translate-y-2 hover:border-[#18f2e5]/40">
                  {/* 1. IMAGE CONTAINER */}
