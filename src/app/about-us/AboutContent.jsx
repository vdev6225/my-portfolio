...
export default function AboutPage() {
  return (
    <main className="min-h-screen pt-24 pb-20">
      ...
      <section className="container mx-auto px-6 md:px-12">
        <div className="grid grid-cols-1 items-center gap-16 md:grid-cols-2">
          ...
          <div className="relative mx-auto w-full max-w-md">
            ...
            <div className="bg-secondary relative h-[500px] w-full overflow-hidden rounded-2xl">
      ...
      {/* --- STATS STRIP --- */}
      <section className="bg-secondary/50 mt-24 border-y border-slate-800 py-12">
      ...
      <section className="container mx-auto mt-24 px-6 md:px-12">
        <div className="mb-16">
          <h2 className="text-3xl font-bold text-slate-100">What I Bring to the Table</h2>
        </div>
      ...
      <section className="container mx-auto mt-24 px-6 md:px-12">
        <div className="bg-secondary rounded-2xl border border-slate-800 p-8 md:p-12">
...
const FeatureCard = ({ icon, title, desc }) => (
  <div className="group bg-secondary rounded-xl border border-slate-800 p-8 transition-all hover:-translate-y-2 hover:border-[#18f2e5]/50 hover:shadow-lg">
